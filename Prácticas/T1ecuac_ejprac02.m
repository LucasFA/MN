...
t = -3:0.1:0;
disp(" f(x) es la funci�n que empieza en la esquina inferior izquierda");
...
disp("Recordamos que la convergencia de la iteracion funcional requiere que la derivada del método sea ")
x0 = -1.5;
iteraciones = 10;
disp("Método con g1")
for i = 1:iteraciones
